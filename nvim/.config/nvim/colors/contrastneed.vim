...
let s:black          = ["#1d2021", 0]
let s:red            = ["#CC241D", 1]
let s:green          = ["#98971A", 2]
let s:yellow         = ["#D79921", 3]
let s:blue           = ["#458588", 4]
let s:magenta        = ["#B16286", 5]
let s:cyan           = ["#689D6A", 6]
let s:gray           = ["#A89984", 7]
let s:bright_black   = ["#928374", 8]
let s:bright_red     = ["#FB4934", 9]
let s:bright_green   = ["#B8BB26", 10]
let s:bright_yellow  = ["#FABD2F", 11]
let s:bright_blue    = ["#83A598", 12]
let s:bright_magenta = ["#D3869B", 13]
let s:bright_cyan    = ["#8EC07C", 14]
let s:white          = ["#EBDBB2", 15]
...
call s:HL('Search',    s:none, s:yellow)
call s:HL('IncSearch', s:none, s:yellow)

call s:HL('Underlined', s:blue, s:none, s:underline)

call s:HL('StatusLine',   s:red, s:none, s:bold)
...
call s:HL('Comment', s:gray, s:none, s:italic . s:bold)
call s:HL('Todo', s:white, s:none, s:bold . s:italic)
