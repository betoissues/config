 ...
 *6)emptycol         */
static const char *colors[] = {"#EEEEEE","#1C1B19","#7a8c5c","#ff6666","#cc9933","#111111","#000000"};
...
static const char *printAll[]   = { "flameshot", "full", NULL };
...
static key keys[] = {
    ...
    {  0 ,              XF86XK_AudioMute,      start,   {.com=toggleMute}},
    {  0 ,              XF86XK_AudioPlay,      start,   {.com=playPause}},
    {  0 ,              XF86XK_AudioNext,      start,   {.com=playNext}},
    {  0 ,              XF86XK_AudioPrev,      start,   {.com=playPrev}},
